...
import { type FieldCell, FieldCellLabel } from "@/types/gameTypes";
...
<template>
  <button @click.prevent.left="handleLeftClick" @click.prevent.middle="handleMiddleClick"
    @click.prevent.right="handleRightClick" :class="cellClasses">
    <span v-if="fieldCell.label === FieldCellLabel.Flag"><v-icon icon="mdi-flag" /></span>
    <span v-else-if="fieldCell.label === FieldCellLabel.Question"><v-icon icon="mdi-help-circle-outline" /></span>
